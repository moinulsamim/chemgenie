            ...
            <div className="gallerywrap flex flex-wrap gap-3 items-center justify-center max-w-2xl m-auto my-9 ">

                {
                    galleryImages && galleryImages.map((slide, index) => {
                        return (
                            <div className="bg-slate-50 single md:w-52 md:h-52 cursor-pointer border-2 border-solid shadow-lg overflow-hidden flex items-center justify-center rounded-md w-36 h-36 "
                                key={index}
